...
@Injectable(as: GetExamQuestionsRepo)
class GetExamQuestionsRepoImpl implements GetExamQuestionsRepo {
  GetExamQuestionsRemoteDatasource getExamQuestionsRemoteDatasourse;
  ...
  Future<BaseResponse<List<QuestionModel>>> getExamQuestions({
    ...
    switch (questionsResponse) {
      ...
      default:
        throw Exception(
          'Unexpected response type from get exam questions remote datasourse',
        );
    }
  }
}
