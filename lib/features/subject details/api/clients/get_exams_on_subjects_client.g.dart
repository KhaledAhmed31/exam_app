...
part of 'get_exams_on_subjects_client.dart';
...
class _GetExamsOnSubjectsClient implements GetExamsOnSubjectsClient {
  _GetExamsOnSubjectsClient(this._dio, {this.baseUrl, this.errorLogger});
