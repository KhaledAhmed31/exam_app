...
part of 'reset_password_client.dart';
...
class _ResetPasswordClient implements ResetPasswordClient {
  _ResetPasswordClient(this._dio, {this.baseUrl, this.errorLogger});
