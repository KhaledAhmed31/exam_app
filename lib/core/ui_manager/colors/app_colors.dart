...
class AppColors {
  ...
  static const Color darkBlue = Color(0xFF2C3A59);
  static const Color darkGreen = Color(0xFF1E5128);
  static const Color placholder = Color(0xFFA6A6A6);
  ...
  static const Color blue50 = Color(0xFF2C58AC);
