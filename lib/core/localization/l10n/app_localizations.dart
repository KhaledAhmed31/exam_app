...
abstract class AppLocalizations {
  ...
  /// No description provided for @doNotReceiveCode.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @resendCodeSuccessMessage.
  ///
  /// In en, this message translates to:
  /// **'Code sent successfully'**
  String get resendCodeSuccessMessage;
  ...
  /// No description provided for @confirmPassowrdLabel.
  ///
  /// In en, this message translates to:
  /// **'Confirm password'**
